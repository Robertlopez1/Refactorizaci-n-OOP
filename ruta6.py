...
# Función para quitar un obstáculo en una posición específica
def quitar_obstaculo(mapa, fila, columna):
    if mapa[fila][columna] in [EDIFICIO, AGUA, BACHE]:
...
# Solicitar al usuario la posición del obstáculo que desea quitar
fila_obstaculo = int(input("Ingrese la fila del obstáculo a quitar: "))
columna_obstaculo = int(input("Ingrese la columna del obstáculo a quitar: "))
quitar_obstaculo(mapa, fila_obstaculo, columna_obstaculo)

# Imprimimos la matriz después de quitar el obstáculo
print("Mapa después de quitar el obstáculo:")
imprimir_matriz(mapa)
